...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white dark:from-gray-900 dark:to-gray-800 light: from-gray-900 light: to-gray-800">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative">
          ...
          <div className="relative z-10 text-center pt-20 pb-16 sm:pt-24 sm:pb-20">
            <h1 className="text-4xl font-extrabold tracking-tight text-gray-300 dark:text-white sm:text-5xl md:text-6xl">
              <span className="block">Book Your Band.</span>
              <span className="block text-purple-600 dark:text-purple-400">Make More Money.</span>
            </h1>
            
            <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-300 dark:text-gray-300">
